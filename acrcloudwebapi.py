#! /usr/bin/env python3
# acrcloudwebapi.py - interface with ACRCloud's music recognition web API
...
if __name__ == '__main__':
    ...
    account_access_secret = b'XXXX'
    project_access_key = 'XXXX'
    stream_id_STATIONX = 'XXXX'
    console = ACRCloudConsole(account_access_key, account_access_secret)
    monitor_STATIONX = ACRCloudStreamMonitor(project_access_key, stream_id_STATIONX)
